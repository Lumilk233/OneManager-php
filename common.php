...
function main($path)
{
    ...
    global $drive;
        ...
        include_once('WebDAV.php');
        if (function_exists('mainDAV')) {
            return mainDAV($path);
       }
    ...
    if ($_SERVER['ajax']) {
        ...
        savecache('path' . $path1, '', $_SERVER['disktag'], 1); // clear cache.
